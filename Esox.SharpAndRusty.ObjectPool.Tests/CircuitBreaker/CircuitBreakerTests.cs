...
public class CircuitBreakerTests
{
    ...
    public void CircuitBreaker_AfterFailureThreshold_OpensCircuit()
    {
        ...
        var breaker = new ObjectPool.CircuitBreaker.CircuitBreaker(config);
    ...
    public void CircuitBreaker_WhenOpen_RejectsOperations()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            try
            {
                breaker.Execute<int>(() => throw new Exception());
            }
            catch
            {
            }
    ...
    public void CircuitBreaker_InHalfOpen_ReopensOnFailure()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            try
            {
                breaker.Execute<int>(() => throw new Exception("Failure after reset"));
            }
            catch
            {
            }
    ...
    public void CircuitBreaker_CustomExceptionFilter_IgnoresSpecificExceptions()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            try
            {
                breaker.Execute<int>(() => throw new ArgumentException());
            }
            catch
            {
            }
