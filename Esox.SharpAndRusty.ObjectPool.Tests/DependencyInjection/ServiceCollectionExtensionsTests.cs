...
public class ServiceCollectionExtensionsTests
{
    ...
    public void AddQueryableObjectPool_RegistersQueryablePool()
    {
        ...
        using var ford = (pool.GetObject(c => c.Make == "Ford")).Unwrap();
    ...
    public void ObjectPoolBuilder_WithMaxSize_SetsConfiguration()
    {
        ...
        // Next one should fail with an error result
        var overLimitResult = pool.GetObject();
        Assert.True(overLimitResult.IsFailure);
    ...
    public async Task AddObjectPool_WithAsyncRetrieval_Works()
    {
        ...
        // Act
        using var obj = (await pool!.GetObjectAsync()).Unwrap();
